...
function clothing(f: Fields): string {
  return compact([
...
function social(f: Fields): string {
  return compact([
    f.subject || "[SUBJECT]",
    f.style,
...
function marketing(f: Fields): string {
  return compact([
    f.product
...
function brand(f: Fields): string {
...
function threeD(f: Fields): string {
  return compact([
...
function jewelry(f: Fields): string {
  return compact([
...
function collection(f: Fields): string {
  return compact([
    (f.subject || "[SUBJECT]") + " design",
    f.style ? f.style + " style" : undefined,
...
function freestyle(f: Fields): string {
  return compact([
    f.subject || "[SUBJECT]",
    f.style ? f.style + " style" : undefined,
    f.mood,
...
function album(f: Fields): string {
  return compact([
    f.subject || "[SUBJECT]",
    f.style,
...
function sticker(f: Fields): string {
  return compact([
...
function wallpaper(f: Fields): string {
  return compact([
    f.subject || "[SUBJECT]",
    f.style,
    f.mood ? f.mood + " atmosphere" : undefined,
...
function mockup(f: Fields): string {
  return compact([
...
function tattoo(f: Fields): string {
  return compact([
...
function sneaker(f: Fields): string {
  return compact([
...
function character(f: Fields): string {
  return compact([
...
function bookcover(f: Fields): string {
  return compact([
...
function carwrap(f: Fields): string {
  return compact([
