...
export function RecipeCard({ recipe }: RecipeCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group bg-bg-2 border border-border rounded-xl p-4 hover:border-accent/40 transition-colors"
    >
      {/* Header */}
      ...
      {fieldEntries.length > 0 && (
        <div className="bg-bg-input rounded-lg p-3 mb-3 space-y-1">
      ...
      <div className="flex flex-wrap gap-1.5 mb-3">
        {recipe.styles.length > 0 && (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-accent/5 border border-accent/10 text-[10px] text-accent/80">
      ...
      <div className="flex items-center gap-2 pt-2 border-t border-border">
        ...
        <button
          ...
          className={clsx(
            ...
            confirmDelete
              ? "text-red-500 bg-red-500/10 font-medium px-2"
